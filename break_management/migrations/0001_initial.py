...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('break_slots_per_hour', models.IntegerField(default=4)),
                ('working_hours_start', models.TimeField()),
                ('working_hours_end', models.TimeField()),
                ('is_rush_hour', models.BooleanField(default=False)),
                ('rush_hour_start', models.TimeField(blank=True, null=True)),
                ('rush_hour_end', models.TimeField(blank=True, null=True)),
